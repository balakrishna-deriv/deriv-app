...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("@deriv/account/dist/account/css/reset-trading-password-modal.css"), require("@deriv/account/dist/account/js/file-uploader-container"), require("@deriv/account/dist/account/js/form-sub-header"), require("@deriv/account/dist/account/js/poa-expired"), require("@deriv/account/dist/account/js/poa-needs-review"), require("@deriv/account/dist/account/js/poa-status-codes"), require("@deriv/account/dist/account/js/poa-submitted"), require("@deriv/account/dist/account/js/poa-unverified"), require("@deriv/account/dist/account/js/poa-verified"), require("@deriv/account/dist/account/js/proof-of-identity-container"), require("@deriv/account/dist/account/js/reset-trading-password-modal"), require("@deriv/account/dist/account/js/sent-email-modal"), require("@deriv/components"), require("@deriv/shared"), require("@deriv/translations"), require("mobx"), require("mobx-react"), require("react"), require("react-dom"), require("react-router"), require("react-router-dom"));
	else if(typeof define === 'function' && define.amd)
		define(["@deriv/account/dist/account/css/reset-trading-password-modal.css", "@deriv/account/dist/account/js/file-uploader-container", "@deriv/account/dist/account/js/form-sub-header", "@deriv/account/dist/account/js/poa-expired", "@deriv/account/dist/account/js/poa-needs-review", "@deriv/account/dist/account/js/poa-status-codes", "@deriv/account/dist/account/js/poa-submitted", "@deriv/account/dist/account/js/poa-unverified", "@deriv/account/dist/account/js/poa-verified", "@deriv/account/dist/account/js/proof-of-identity-container", "@deriv/account/dist/account/js/reset-trading-password-modal", "@deriv/account/dist/account/js/sent-email-modal", "@deriv/components", "@deriv/shared", "@deriv/translations", "mobx", "mobx-react", "react", "react-dom", "react-router", "react-router-dom"], factory);
	else if(typeof exports === 'object')
		exports["@deriv/cfd"] = factory(require("@deriv/account/dist/account/css/reset-trading-password-modal.css"), require("@deriv/account/dist/account/js/file-uploader-container"), require("@deriv/account/dist/account/js/form-sub-header"), require("@deriv/account/dist/account/js/poa-expired"), require("@deriv/account/dist/account/js/poa-needs-review"), require("@deriv/account/dist/account/js/poa-status-codes"), require("@deriv/account/dist/account/js/poa-submitted"), require("@deriv/account/dist/account/js/poa-unverified"), require("@deriv/account/dist/account/js/poa-verified"), require("@deriv/account/dist/account/js/proof-of-identity-container"), require("@deriv/account/dist/account/js/reset-trading-password-modal"), require("@deriv/account/dist/account/js/sent-email-modal"), require("@deriv/components"), require("@deriv/shared"), require("@deriv/translations"), require("mobx"), require("mobx-react"), require("react"), require("react-dom"), require("react-router"), require("react-router-dom"));
	else
		root["@deriv/cfd"] = factory(root["@deriv/account/dist/account/css/reset-trading-password-modal.css"], root["@deriv/account/dist/account/js/file-uploader-container"], root["@deriv/account/dist/account/js/form-sub-header"], root["@deriv/account/dist/account/js/poa-expired"], root["@deriv/account/dist/account/js/poa-needs-review"], root["@deriv/account/dist/account/js/poa-status-codes"], root["@deriv/account/dist/account/js/poa-submitted"], root["@deriv/account/dist/account/js/poa-unverified"], root["@deriv/account/dist/account/js/poa-verified"], root["@deriv/account/dist/account/js/proof-of-identity-container"], root["@deriv/account/dist/account/js/reset-trading-password-modal"], root["@deriv/account/dist/account/js/sent-email-modal"], root["@deriv/components"], root["@deriv/shared"], root["@deriv/translations"], root["mobx"], root["mobx-react"], root["react"], root["react-dom"], root["react-router"], root["react-router-dom"]);
...
/******/ 			return "cfd/js/cfd." + chunkId + "." + {"404":"bedbbbd32e89c9ef566d","vendors-node_modules_classnames_index_js-node_modules_formik_dist_formik_esm_js-node_modules_-611d03":"4d87207c4cf8909cc15c","cfd-app":"b9ceee9a88ca1970583c"}[chunkId] + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ 			// return url for filenames based on template
/******/ 			return "cfd/css/cfd." + chunkId + "." + "8c3af5a8e2a08b17ee93" + ".css";
/******/ 		};
/******/ 	})();
/******/ 	
